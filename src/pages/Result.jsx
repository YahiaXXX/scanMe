...
export default function DataTable() {
  ...
  const {id} = useParams()
  const url =`http://165.232.152.255:8080/scanner/target/${id}/subdomains/`
  ...
  return (
    <>
    {loading ? <div className=' flex justify-center items-center w-full h-screen' > <Spinner color={currentColor} /></div>    : <div className=' py-10 mt-20' >
  ...
  <div className=' flex md:flex-row gap-4 flex-col ss:justify-start justify-center mt-4 ml-0 items-center' >
    ...
    <ResultCard color={currentColor} title="Average time:" display={`${ (moy!==null && moy!==undefined ) ? moy   : 0} ms`} icon={<MdAccessTime/>}  /> 
